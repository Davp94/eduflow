       ...
       <div className="dashboard-page container">
          <div className="dashboard-header">
            <div className="dashboard-title-area">
              ...
              <p className="dashboard-subtitle">Lorem ipsum aibus? Tempora labore odio harum quo, quibusdam facere culpa nesciunt.</p>
            </div>
          ...
          <div className="course-grid">
            <div className="add-course-card">
              ...
              <h3 className="add-course-title">Ad new Course</h3>
          ...
          <div className="generator-banner">
            <div className="generator-content">
              ...
              <div className="generator-text">
                ...
                <p className="generator-desc">Use AI based your requirements</p>
              </div>
            </div>
